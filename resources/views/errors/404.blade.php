                    ...
                    <div class="w-layout-blockcontainer container-default w-container">
                        <div class="utility-page-wrap">
                            <div class="content-wrapper-404"><img src="{{ asset('home/images/image-404.png') }}"
                                ...
                                <a data-w-id="1ff69c0c-e430-f24d-841e-32a19cf21a9f" href="{{ route('index') }}"
                        ...
                        <div class="w-layout-blockcontainer container-default w-container">
                            <div class="footer-main-block">
                                ...
                                <div class="footer-column">
                                    ...
                                    <div class="footer-link-wrapper">
                                        <a href="{{ route('tNc') }}" class="footer-link">Teams and
                                            Condition</a>
                                        <a href="{{ route('pp') }}" class="footer-link">Privacy Policy&#x27;s </a>
                                    </div>
                                </div>
                            </div>
                        </div>
