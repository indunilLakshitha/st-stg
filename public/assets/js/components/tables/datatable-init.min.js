...
var initZeroConfig = function initZeroConfig() {
    ...
    initDataTablesExportCustomer = function initDataTablesExportCustomer() {
        $("#dataTablesExportCustomer").DataTable({
            dom: "Bfrtip",
            responsive: !0,
            buttons: {
                dom: {
